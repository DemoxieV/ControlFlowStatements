...
## **Теория и практика Java Core. Управляющие инструкции**
...
**Основная тема:** "Управляющие инструкции"

**Ключевые подтемы:**
- инструкции выбора (if, switch);
- итерационные инструкции (for, while, do-while);
- цикл по коллекции (for each);
- инструкции перехода (break, continue, return);
- тернарный оператор.
...
**Добавлено 6 альтернативных способов решений задач**
